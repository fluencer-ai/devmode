...
> Adapted from [`agent0ai/dox`](https://github.com/agent0ai/dox), MIT — the
> AGENTS.md-tree contract hierarchy, pre-edit traversal, and post-edit "DOX
> pass". Reframed tool-agnostically and scoped against devmode's module map.
