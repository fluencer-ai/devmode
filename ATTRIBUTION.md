...
- **`lopopolo/harness-engineering` is CC-BY-4.0**, not MIT — attribution is a
  *license condition*, not a courtesy. We reused **ideas from its prose essays**
  (no files copied), reframed in the devmode voice; this file and the README
  provide the required credit to Ryan Lopopolo.
